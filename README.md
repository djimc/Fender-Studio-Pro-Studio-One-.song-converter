...
The script makes projects saved in v8 usable with v7 and v6 again. I have also "created" a small cross-platform GUI app based on this script which I will upload after I test for other plugins that need "fixing".
